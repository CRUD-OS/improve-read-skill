...
export default function EasySentenceBuilder() {
  ...
  return (
    <Card className="max-w-3xl mx-auto p-4 space-y-6 bg-gradient-to-br from-green-50 to-teal-100 ">
      ...
      <Card className=" shadow-lg rounded-3xl border-2 border-green-200 min-h-[4rem] overflow-x-auto">
        <CardContent className="flex flex-wrap gap-2">
          {selectedOrder.length === 0 && (
            <div className="text-gray-950 w-full text-center">
              🔹 Доороос сонгож дээш оруулна уу...
            </div>
          )}
          ...
          {selectedOrder.map((part, idx) => (
            <Button
              ...
              className={`inline-block px-3 py-2 rounded-xl text-sm whitespace-nowrap  ${
                ...
                revealed
                  ? part === correctOrder[idx]
                    ? "bg-green-400 text-gray-950"
                    : "bg-red-400 text-black line-through"
                  : ""
              }`}
